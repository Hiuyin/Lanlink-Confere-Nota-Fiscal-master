...
const nota = require('./routes/recuperaNotas')
...
app.get('/nota/:Empresa/:Filial/:Serie/:Nota', async (req, res) => {
  if (req.session.isAuthenticated) {
    ...
    //console.log(Filial);
    await nota.recuperaNota(Empresa,Filial,Serie,Nota, res)
    //res.render('index3Visualizacao')
  } else {
    res.redirect('/')
  }
})
